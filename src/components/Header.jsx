...
function Header() {
  ...
  return (
    <section className={`${mode === "dark" ? "dark" : ""}`} id='header'>
      <div className={`header-container ${mode === "dark" ? "dark" : ""}`}>
        ...
        <div className='logo-container'>
          <img className={`${mode === "dark" ? "dark-logo" : ""}`} src={logo} alt='' />
        </div>
        <div className='icons'>
          ...
          <div onClick={() => {
            ...
            {mode === "dark" ? <i className="fa-solid fa-moon"></i> : <i class="fa-regular fa-sun"></i>}
          </div>
